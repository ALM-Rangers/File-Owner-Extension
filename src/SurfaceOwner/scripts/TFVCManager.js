define(["require", "exports", "Scripts/TFVCRawRestClient"], function (require, exports, TFVCRawRestClient) {
    var TFVCManager = (function () {
        //----------------------------------------------------
        // Instantiates a TFVC Manager object
        //----------------------------------------------------
        function TFVCManager(webContext) {
        ...
        TFVCManager.prototype.findLatestReviewedAsync = function (key, counter, changesets) {
            var self = this;
        ...
        //---------------------------------------------------------------
        TFVCManager.prototype.findLatestReviewed = function (path, changesets, processObj, promise) {
            var self = this;
        ...
        //------------------------------------------------------------------------
        TFVCManager.prototype.getUserImageUrl = function (userId) {
            var result = $.Deferred();
            var self = this;
        ...
        //------------------------------------------------------------------------
        TFVCManager.prototype.calculateOwners = function (path, parentFolder) {
            var _this = this;
            var self = this;
            //TEST CODE BEGIN
            ...
            VSS.require(["VSS/Service", "TFS/VersionControl/TfvcRestClient", "TFS/VersionControl/Contracts"], function (Service, RestClient, Contracts) {
                ...
                //                (changesetRefs) => {
                var tfvcRawRestClient = new TFVCRawRestClient.TFVCRawRestClient(_this.webContext);
                tfvcRawRestClient.getChangesets(path).then(function (changesetRefs) {
        ...
        //----------------------------------------------------------------
        TFVCManager.prototype.calculateFileLength = function (path) {
            var self = this;
            var result = $.Deferred();
            VSS.require(["VSS/Service", "TFS/VersionControl/TfvcRestClient", "TFS/VersionControl/Contracts"], function (Service, RestClient, Contracts) {
                var gitClient = RestClient.getClient();
                gitClient.getItemContent(path, undefined, undefined, true, undefined, undefined, undefined).then(function (arrayBuffer) {
    ...
    exports.TFVCManager = TFVCManager;
});
//# sourceMappingURL=TFVCManager.js.map